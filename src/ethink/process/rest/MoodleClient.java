...
public class MoodleClient {
    ...
    public static void main(String[] args) throws ProtocolException, IOException {
        ...
        /// NEED TO BE CHANGED
        String token = "bcf732f1d38d4fcf2e9e5a329b6fdec7";
        
        String domainName = "https://myelearning.cavehill.uwi.edu";
...
//        String restformat = "xml"; //Also possible in Moodle 2.2 and later: 'json'
        ...
        "users[0][username]=" + URLEncoder.encode("sheldontest", "UTF-8") +
...
//        "&users[1][email]=" + URLEncoder.encode("testemail2@moodle.com", "UTF-8") +
        "&users[0][suspended]=" + URLEncoder.encode("1", "UTF-8");
