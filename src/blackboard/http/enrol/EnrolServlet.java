...
import blackboard.util.MoodleEnrolTask;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class EnrolServlet extends JAXMServlet{
	
	private ArrayList list;
	private Timer leasingTimer;
	private Timer enrolTimer;
	...
	public void init(ServletConfig servletConfig) throws ServletException {
		...
		MoodleEnrolTask task = new MoodleEnrolTask(effTerm, endPoint);
		
		task.setServer(this);
		
		enrolTimer = new Timer();
		enrolTimer.schedule(task,0,interval *  20 * 1000);
		
		//enrolTimer.schedule(task,0,5 * 1000);
