...
import blackboard.util.DropEnrolTask;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DropServlet extends JAXMServlet{
	...
	public void init(ServletConfig servletConfig) throws ServletException {
		...
		DropEnrolTask task = new DropEnrolTask(effTerm, endPoint);
		
		
		dropTimer = new Timer();
		dropTimer.schedule(task,0,interval *  60 * 60  * 1000);
