package blackboard.http.course;
...
import blackboard.exceptions.MalRequestFormatException;
import blackboard.exceptions.ReplyException;
...
//  The XML Schema instance namespace
    ...
    protected static final String SERVICE_PREFIX = "ns2";
   
    //  Namespace prefix for list service    
    protected static final String SERVICE_LIST_PREFIX = "ns3";
...
//  The namespace prefix used for SOAP encoding
	...
	public SOAPMessage onMessage(SOAPMessage message) {
		...
		try {
			...
			MessageLogger.out.println("Show me a motion"); 
