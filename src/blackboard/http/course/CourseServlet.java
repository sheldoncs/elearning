 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class CourseServlet extends JAXMServlet{
	...
	public void init(ServletConfig servletConfig) throws ServletException {
		...
		*/ 
		...
		MoodleCourseTask task = new MoodleCourseTask(effTerm, endPoint);
		
		task.setServer(this);
		
		courseTimer = new Timer();
		courseTimer.schedule(task,0, 2 * interval *  60 * 1000);
