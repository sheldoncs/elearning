...
public class ReadInUserXML extends LoadXML{
	...
	int cnt =0; 
	public ReadInUserXML(){
		super();
	}
	public void ReadIn(){
		try {
	        BufferedReader in = new BufferedReader(new FileReader("xml/people.xml"));
	...
	{
		ReadInUserXML xml = new ReadInUserXML();
